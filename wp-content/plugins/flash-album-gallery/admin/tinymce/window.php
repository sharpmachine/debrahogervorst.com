...
<head>
	<title><?php _e("Insert Flash Album with one or more galleries", 'flash-album-gallery'); ?></title>
...
<form name="FlAG" action="#">
	<div class="cptabs_wrapper">
		<ul id="tabs" class="tabs">
			...
			<li><a href="#" rel="music_panel"><span><?php _e( 'Music', 'flash-album-gallery' ); ?></span></a></li>
		</ul>
		...
		<table border="0" cellpadding="4" cellspacing="0">
         ...
         <tr>
            <td nowrap="nowrap" valign="middle"><label for="galleries"><?php _e("Select galleries", 'flash-album-gallery'); ?>:</label><br /><small><?php _e("(album categories)", 'flash-album-gallery'); ?></small></td>
...
?>
		 ...
		 <tr>
            ...
            <td valign="top"><?php _e("width", 'flash-album-gallery'); ?>: <input id="gallerywidth" type="text" name="gallerywidth" style="width: 50px" /> &nbsp; <?php _e("height", 'flash-album-gallery'); ?>: <input id="galleryheight" type="text" name="galleryheight" style="width: 50px" /></td>
		 </tr>
		 <tr>
		...
		<table border="0" cellpadding="4" cellspacing="0">
         <tr>
            <td nowrap="nowrap" valign="top" width="35%"><div style="display: block; white-space: normal;"><?php _e("Choose playlist for background music", 'flash-album-gallery'); ?>:</div></td>
