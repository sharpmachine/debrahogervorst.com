<?php function flag_skin_options() {
	...
	<form method="POST">
		<div>
			...
			<!-- Color settings -->
			<h3><?php _e( 'Color Settings', 'flash-album-gallery' ); ?></h3>
			<table id="colors" class="form-table flag-options">
				<tr>
					<th style="width: 30%;"><?php _e( 'Background Color', 'flash-album-gallery' ); ?>:</th>
				...
				<tr>
					<th><?php _e( 'Buttons Background Color', 'flash-album-gallery' ); ?>:</th>
				...
				<tr>
					<th><?php _e( 'Buttons Text Color', 'flash-album-gallery' ); ?>:</th>
					<td>
				...
				<tr>
					<th><?php _e( 'Category Buttons Text Color', 'flash-album-gallery' ); ?>:</th>
					<td>
				...
				<tr>
					<th><?php _e( 'Thumbs Rollover Color', 'flash-album-gallery' ); ?>:</th>
					<td>
				...
				<tr>
					<th><?php _e( 'Main Title', 'flash-album-gallery' ); ?>:</th>
				...
				<tr>
					<th><?php _e( 'Category Title', 'flash-album-gallery' ); ?>:</th>
				...
				<tr>
					<th><?php _e( 'Item Background', 'flash-album-gallery' ); ?>:</th>
				...
				<tr>
					<th><?php _e( 'Item Title', 'flash-album-gallery' ); ?>:</th>
				...
				<tr>
					<th><?php _e( 'Item Description', 'flash-album-gallery' ); ?>:</th>
