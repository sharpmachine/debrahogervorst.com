...
?>
		...
		<tr>
            ...
            <td valign="top"><input id="mb_button" name="mb_button" type="text" style="width: 49%;" placeholder="Home" value="<?php echo $button_text; ?>" /><br />
							<small><?php _e("Leave empty to hide Back button", 'flash-album-gallery'); ?></small></td>
		</tr>
		<tr>
		...
		<tr>
			<td nowrap="nowrap" valign="top"><div style="padding-top: 3px;"><?php _e("Music", 'flash-album-gallery'); ?>: &nbsp; </div></td>
      	<td valign="top"><select id="mb_playlist" name="mb_playlist">
						<option value="" selected="selected" <?php selected($music,''); ?>><?php _e("choose playlist", 'flash-album-gallery'); ?></option>
						<?php
					...
					<small><?php _e("(optional) Read Skin specification for supporting this function.", 'flash-album-gallery'); ?></small></td>
		</tr>
		<tr>
            ...
            <td valign="top"><input id="mb_bg_link" name="mb_bg_link" type="text" style="width: 49%;"  value="<?php echo $bg_link; ?>" /><br />
				<small><?php _e("(optional) Be sure you set Wmode to 'transparent' in skin's options", 'flash-album-gallery'); ?></small></td>
		</tr>
        <tr>
