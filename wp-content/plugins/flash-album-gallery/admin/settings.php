...
<div id="slider" class="flag-wrap">
	...
	<ul id="tabs" class="tabs">
		<li class="selected"><a href="#" rel="imageoptions"><?php _e('Gallery Options', 'flash-album-gallery'); ?></a></li>
		<li><a href="#" rel="grandpages"><?php _e('GRAND Pages', 'flash-album-gallery'); ?></a></li>
		<?php if(current_user_can('administrator')){ ?>
		<li><a href="#" rel="rControl"><?php _e('License Key & Remote Control', 'flash-album-gallery'); ?></a></li>
		<?php } ?>
		<li><a href="#" rel="vPlayer"><?php _e('FLV Single Player Options', 'flash-album-gallery'); ?></a></li>
		<li><a href="#" rel="mPlayer"><?php _e('MP3 Single Player Options', 'flash-album-gallery'); ?></a></li>
		...
		<?php wp_nonce_field('flag_settings'); ?>
			...
			<table class="form-table flag-options" style="width: auto; white-space: nowrap;">
				<tr valign="top">
					...
					<span class="setting-description"><?php _e('This is the default path for all galleries','flash-album-gallery'); ?></span></td>
				</tr>
				<tr valign="top">
					<th><?php _e('Default flash size (W x H)','flash-album-gallery'); ?>:</th>
				...
				<tr valign="top">
					...
					<?php _e('Delete files, when removing a gallery in the database','flash-album-gallery'); ?></td>
				</tr>
				<tr>
					<th align="left"><?php _e('Activate Deep Linking (optional)','flash-album-gallery'); ?><br /><small><?php _e('Not all skins support this feature.','flash-album-gallery'); ?></small></th>
					<td><input type="checkbox" name="deepLinks" value="1" <?php checked('1', $flag_options['deepLinks']); ?> />
					<span class="setting-description"><?php _e('Deep links for images in flash.','flash-album-gallery'); ?></span></td>
				</tr>
				<tr>
					...
					<span class="setting-description"><?php _e('A RSS feed will be added to you blog header.','flash-album-gallery'); ?></span></td>
				</tr>
			</table>
			...
			<table class="form-table flag-options" style="width: auto; white-space: nowrap;">
				<tr valign="top">
					<th scope="row" width="200"><label><?php _e('Use optimized images for mobile browsers','flash-album-gallery'); ?></label><br /><small>(Manage Gallery -> 'Optimize images for web' action)</small></th>
					<td><input type="checkbox" name="optimized_imgs" value="1" <?php checked('1', $flag_options['optimized_imgs']); ?> />
						<span class="setting-description"><?php _e('Optimized images loads faster, save traffic and make page more lightweight for browser','flash-album-gallery'); ?></span></td>
				</tr>
				<tr valign="top">
					<th align="left"><?php _e('Image quality','flash-album-gallery'); ?></th>
					<td><input type="text" size="3" maxlength="3" name="imgQuality" value="<?php echo $flag_options['imgQuality']; ?>" /> % &nbsp;&nbsp;<span class="setting-description"><?php _e('Default: 85%','flash-album-gallery'); ?></span></td>
				</tr>
			</table>
			...
			<table class="form-table flag-options" style="width: auto; white-space: nowrap;">
				<tr>
					...
					<td valign="top">
						<label><input name="albSort" type="radio" value="gid" <?php checked('gid', $flag_options['albSort']); ?> /> <?php _e('Gallery ID', 'flash-album-gallery'); ?></label><br />
						<label><input name="albSort" type="radio" value="title" <?php checked('title', $flag_options['albSort']); ?> /> <?php _e('Title', 'flash-album-gallery'); ?></label><br />
					</td>
					<td valign="top"><label><input name="albSortDir" type="radio" value="ASC" <?php checked('ASC', $flag_options['albSortDir']); ?> /> <?php _e('Ascending', 'flash-album-gallery'); ?></label><br />
						<label><input name="albSortDir" type="radio" value="DESC" <?php checked('DESC', $flag_options['albSortDir']); ?> /> <?php _e('Descending', 'flash-album-gallery'); ?></label>
					</td>
				</tr>
				...
				<tr>
					...
					<td valign="top">
						<label><input name="galSort" type="radio" value="sortorder" <?php checked('sortorder', $flag_options['galSort']); ?> /> <?php _e('Custom order', 'flash-album-gallery'); ?></label><br />
						<label><input name="galSort" type="radio" value="pid" <?php checked('pid', $flag_options['galSort']); ?> /> <?php _e('Image ID', 'flash-album-gallery'); ?></label><br />
						<label><input name="galSort" type="radio" value="filename" <?php checked('filename', $flag_options['galSort']); ?> /> <?php _e('File name', 'flash-album-gallery'); ?></label><br />
						<label><input name="galSort" type="radio" value="alttext" <?php checked('alttext', $flag_options['galSort']); ?> /> <?php _e('Alt / Title text', 'flash-album-gallery'); ?></label><br />
						<label><input name="galSort" type="radio" value="imagedate" <?php checked('imagedate', $flag_options['galSort']); ?> /> <?php _e('Date / Time', 'flash-album-gallery'); ?></label><br />
						<label><input name="galSort" type="radio" value="hitcounter" <?php checked('hitcounter', $flag_options['galSort']); ?> /> <?php _e('Image views', 'flash-album-gallery'); ?></label><br />
						<label><input name="galSort" type="radio" value="total_votes" <?php checked('total_votes', $flag_options['galSort']); ?> /> <?php _e('Image likes', 'flash-album-gallery'); ?></label><br />
						<label><input name="galSort" type="radio" value="rand()" <?php checked('rand()', $flag_options['galSort']); ?> /> <?php _e('Randomly', 'flash-album-gallery'); ?></label>
					</td>
					<td valign="top"><label><input name="galSortDir" type="radio" value="ASC" <?php checked('ASC', $flag_options['galSortDir']); ?> /> <?php _e('Ascending', 'flash-album-gallery'); ?></label><br />
						<label><input name="galSortDir" type="radio" value="DESC" <?php checked('DESC', $flag_options['galSortDir']); ?> /> <?php _e('Descending', 'flash-album-gallery'); ?></label>
					</td>
				</tr>
			</table>

			<h3><?php _e('Alternative Gallery Options','flash-album-gallery'); ?> <br><small style="color: darkgreen;"><?php _e('(Note: this is not flash skin option. Options below only for alternative gallery in mobile browsers)','flash-album-gallery'); ?></small></h3>
			<table class="flag_colors form-table flag-options" style="width: auto; white-space: nowrap;">
				<tr>
					<th align="left"><?php _e('Show jQuery gallery for browsers without flashplayer','flash-album-gallery'); ?></th>
					<td><input type="checkbox" name="jAlterGal" value="1" <?php checked('1', $flag_options['jAlterGal']); ?> /></td>
				</tr>
				<tr>
					<th align="left"><?php _e('jQuery gallery script','flash-album-gallery'); ?></th>
				...
				<tr>
					<th align="left"><?php _e('Disable image views/likes counter on thumbnails','flash-album-gallery'); ?></th>
					<td><input type="checkbox" name="disableViews" value="1" <?php checked('1', $flag_options['disableViews']); ?> /></td>
				</tr>
				<tr>
					<th width="200"><?php _e('Top Bar BG','flash-album-gallery'); ?>:</th>
				...
				<tr>					
					<th><?php _e('Category Buttons BG','flash-album-gallery'); ?>:</th>
					<td>
				...
				<tr>					
					<th><?php _e('Category Buttons Color','flash-album-gallery'); ?>:</th>
					<td>
				...
				<tr>					
					<th><?php _e('Thumbnail BG','flash-album-gallery'); ?>:</th>
				...
				<tr>					
					<th><?php _e('Thumbnail MouseOver BG','flash-album-gallery'); ?>:</th>
				...
				<tr>
					<th><?php _e('Fancybox Title','flash-album-gallery'); ?>:<br /><small><?php _e('Only if FancyBox script is selected','flash-album-gallery'); ?></small></th>
				...
				<tr>
					<th><?php _e('Fancybox Description Text','flash-album-gallery'); ?>:<br /><small><?php _e('Only if FancyBox script is selected','flash-album-gallery'); ?></small></th>
			...
			<div class="submit"><input class="button-primary" type="submit" name="updateoption" value="<?php _e('Save Changes', 'flash-album-gallery'); ?>"/></div>
		</form>	
	</div>
...
<?php if(current_user_can('administrator')){ ?>
	<div id="rControl" class="cptab">
		<form name="rControl"  method="post" style="float: left;width: 50%;">
			...
			<h2><?php _e('License Key & Remote Control','flash-album-gallery'); ?></h2>
			...
			<table class="form-table flag-options" style="">
				<tr>
					<th valign="top" width="200"><a href="http://mypgc.co/membership/" target="_blank"><?php _e('License Key', 'flash-album-gallery') ?></a>:</th>
					<td valign="top"><input type="text" size="40" id="license_key" name="license_key" value="<?php echo $flag_options['license_key']?>" /></td>
				</tr>
				<tr>
					<td colspan="2"><br><?php _e('If you want to upload photos to FlAGallery right from your iPhone <a href="https://itunes.apple.com/us/app/mypgc/id663405181?ls=1&mt=8">download application</a> and enter access key below. You can enter your own access key. You can change these at any point in time and this will force all users to have to log in again in application.', 'flash-album-gallery'); ?> </td>
				</tr>
				<tr>
					<th valign="top" width="200"><?php _e('Remote App Access Key','flash-album-gallery'); ?>:</th>
					<td valign="top"><input type="text" size="40" id="access_key" name="access_key" value="<?php echo $flag_options['access_key']?>" />
						<button type="button" onclick="jQuery('#flag_register_form').toggle();"><?php _e('Register free account Form', 'flash-album-gallery') ?></button>
						<br><small><?php _e('Leave blank to disable access from application', 'flash-album-gallery'); ?></small></td>
				</tr>
			</table>
			...
			<div class="submit"><input class="button-primary" type="submit" name="membership" value="<?php _e('Update Settings for Remote Access', 'flash-album-gallery'); ?>"/></div>
		</form>
		...
		<form id="flag_register_form" name="reg_on_mypgc" method="post" style="<?php if(!$regform || !empty($flag_options['access_key'])){ ?>display:none;<?php } ?> float: left; border: 1px solid #666666; background-color: #ffffee; margin-top: 95px; width: 49%;">
			<?php wp_nonce_field('flag_settings'); ?>
			<h3 style="padding-left: 10px;"><?php _e('Register with form below or <a href="http://mypgc.co/membership/" target="_blank">purchase license key</a>','flash-album-gallery'); ?></h3>
			<div style="padding:0 10px;">
				<p><?php _e("this email and password that you'll receive will be used to login in iOS application",'flash-album-gallery'); ?></p>
				<p><b><?php _e("Note: if you already purchased license key or already registered this website you don't need register again. Just create your own Access Key and Save",'flash-album-gallery'); ?></b></p>
			</div>
			<input type="hidden" name="access_key" value="<?php echo $flag_options['access_key']?>" />
			<input type="hidden" name="access_url" value="<?php echo plugins_url() . '/' . FLAGFOLDER . '/lib/app.php'; ?>" />
			<table class="form-table" style="100%;">
				<tr>
					<td valign="top" style="width: 50%;"><?php _e('First Name', 'flash-album-gallery') ?>:<br><input type="text" id="customer_first_name" name="customer_first_name" value="" style="width: 95%;" /></td>
					<td valign="top"><?php _e('Last Name', 'flash-album-gallery') ?>:<br><input type="text" id="customer_last_name" name="customer_last_name" value="" style="width: 95%;" /></td>
				</tr>
				<tr>
					<td valign="top"><?php _e('Email', 'flash-album-gallery') ?>:<br><input type="text" size="54" id="customer_email" name="customer_email" value="" style="width: 95%;" /></td>
					<td valign="top"><div class="submit"><input class="button-primary" type="submit" name="register_subscriber" value="<?php _e('Register', 'flash-album-gallery'); ?>"/></div></td>
				</tr>
			</table>
		</form>
...
<?php } ?>
	...
	<div id="vPlayer" class="cptab">
		<form name="vPlayer"  method="post">
			...
			<h2><?php _e('Flash Video Player Colors','flash-album-gallery'); ?></h2>
			<table class="flag_colors form-table flag-options" style="width: auto; white-space: nowrap;">
				<tr>
					<th width="200"><?php _e('Video BG','flash-album-gallery'); ?>:</th>
				...
				<tr>
					<th><?php _e('Color 1','flash-album-gallery'); ?>:</th>
				...
				<tr>
					<th><?php _e('Color 2','flash-album-gallery'); ?>:</th>
					<td>
				...
				<tr>
					<th><?php _e('Autoplay','flash-album-gallery'); ?>:</th>
					<td>
						<label><input name="vmAutoplay" type="radio" value="true" <?php checked('true', $flag_options['vmAutoplay']); ?> /> <?php _e('True', 'flash-album-gallery'); ?></label><br />
						<label><input name="vmAutoplay" type="radio" value="false" <?php checked('false', $flag_options['vmAutoplay']); ?> /> <?php _e('False', 'flash-album-gallery'); ?></label><br />
					</td>
				</tr>
				<tr>
					<th><?php _e('Default Size','flash-album-gallery'); ?>:<br /><small>(width x height)</small></th>
					<td>
	...
	<div id="mPlayer" class="cptab">
		<form name="mPlayer"  method="post">
			...
			<h2><?php _e('MP3 Player Colors','flash-album-gallery'); ?></h2>
			<table class="flag_colors form-table flag-options" style="width: auto; white-space: nowrap;">
				<tr>
					<th width="200"><?php _e('Player BG','flash-album-gallery'); ?>:</th>
				...
				<tr>
					<th><?php _e('Autoplay','flash-album-gallery'); ?>:</th>
					<td>
						<label><input name="mpAutoplay" type="radio" value="true" <?php checked('true', $flag_options['mpAutoplay']); ?> /> <?php _e('True', 'flash-album-gallery'); ?></label><br />
						<label><input name="mpAutoplay" type="radio" value="false" <?php checked('false', $flag_options['mpAutoplay']); ?> /> <?php _e('False', 'flash-album-gallery'); ?></label><br />
					</td>
				</tr>
			</table>
			<div class="submit"><input class="button-primary" type="submit" name="updateoption" value="<?php _e('Save Changes', 'flash-album-gallery'); ?>"/></div>
...
<?php if (flagGallery::flag_wpmu_enable_function('wpmuRoles')) : ?>
	<div id="roles" class="cptab">
		<form method="POST" name="addroles" id="addroles" accept-charset="utf-8">
			...
			<div>&nbsp;</div>
			<p><?php _e('Select the lowest role which should be able to access the follow capabilities. Flash Album Gallery supports the standard roles from WordPress.', 'flash-album-gallery'); ?></p>
			<table class="form-table"> 
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Main Flash Album Gallery overview', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('View TinyMCE Button / GRAND Pages', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Add gallery / Upload images', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Import images folder', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Manage gallery', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Manage others galleries and Albums', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Manage music', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Manage video', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Manage banners', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Change skin', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Add skins', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Delete skins', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('Change options', 'flash-album-gallery'); ?>:</th>
			...
			<tr valign="top"> 
				<th scope="row" style="white-space: nowrap"><?php _e('iFrame page', 'flash-album-gallery'); ?>:</th>
			...
			<div class="submit"><input type="submit" class="button-primary" name= "update_cap" value="<?php _e('Update capabilities', 'flash-album-gallery'); ?>"/></div>
		</form>
	</div>
<?php endif; ?>
</div>
