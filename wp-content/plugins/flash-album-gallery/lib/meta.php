...
class flagMeta {
		...
		if (!is_array($this->exif_array)){
			...
			if(isset($this->exif_data['EXIF'])){
				...
				if (!empty($exif['FocalLength']))
					$meta['focal_length'] = $this->exif_frac2dec( $exif['FocalLength'] ) . __(' mm','flash-album-gallery');
				...
				if (!empty($exif['ExposureTime'])) {
					 ...
					 $meta['shutter_speed'] .=  __(' sec','flash-album-gallery');
					}
				//Bit 0 indicates the flash firing status
				if (!empty($exif['Flash']))
					$meta['flash'] =  ( $exif['Flash'] & 1 ) ? __('Fired', 'flash-album-gallery') : __('Not fired',' flag');
			}
	...
	*/
	function i8n_name($key) {
		$tagnames = array(
		'aperture' 			=> __('Aperture','flash-album-gallery'),
		'credit' 			=> __('Credit','flash-album-gallery'),
		'camera' 			=> __('Camera','flash-album-gallery'),
		'caption' 			=> __('Caption','flash-album-gallery'),
		'created_timestamp' => __('Date/Time','flash-album-gallery'),
		'copyright' 		=> __('Copyright','flash-album-gallery'),
		'focal_length' 		=> __('Focal length','flash-album-gallery'),
		'iso' 				=> __('ISO','flash-album-gallery'),
		'shutter_speed' 	=> __('Shutter speed','flash-album-gallery'),
		'title' 			=> __('Title','flash-album-gallery'),
		'author' 			=> __('Author','flash-album-gallery'),
		'tags' 				=> __('Tags','flash-album-gallery'),
		'subject' 			=> __('Subject','flash-album-gallery'),
		'make' 				=> __('Make','flash-album-gallery'),
		'status' 			=> __('Edit Status','flash-album-gallery'),
		'category'			=> __('Category','flash-album-gallery'),
		'keywords' 			=> __('Keywords','flash-album-gallery'),
		'created_date' 		=> __('Date Created','flash-album-gallery'),
		'created_time'		=> __('Time Created','flash-album-gallery'),
		'position'			=> __('Author Position','flash-album-gallery'),
		'city'				=> __('City','flash-album-gallery'),
		'location'			=> __('Location','flash-album-gallery'),
		'state' 			=> __('Province/State','flash-album-gallery'),
		'country_code'		=> __('Country code','flash-album-gallery'),
		'country'			=> __('Country','flash-album-gallery'),
		'headline' 			=> __('Headline','flash-album-gallery'),
		'source'			=> __('Source','flash-album-gallery'),
		'contact'			=> __('Contact','flash-album-gallery'),
		'last_modfied'		=> __('Last modified','flash-album-gallery'),
		'tool'				=> __('Program tool','flash-album-gallery'),
		'format'			=> __('Format','flash-album-gallery'),
		'width'				=> __('Image Width','flash-album-gallery'),
		'height'			=> __('Image Height','flash-album-gallery'),
		'flash'				=> __('Flash','flash-album-gallery')
		);
