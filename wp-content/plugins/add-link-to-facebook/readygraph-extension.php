<?php
  ...
  // Extension Configuration
	...
	$al2fb_main_plugin_title = 'Add Link to Facebook';

	add_action( 'wp_ajax_nopriv_al2fb-myajax-submit', 'al2fb_myajax_submit' );
...
function add_al2fb_readygraph_plugin_warning() {
  ...
  global $hook_suffix, $current_user, $al2fb_menu_slug;
  ...
  if ( $hook_suffix == 'plugins.php' && get_option('readygraph_connect_notice') == 'true' ) {              
    echo '<div class="updated" style="padding: 0; margin: 0; border: none; background: none;">  
      ...
      <form name="readygraph_activate" action="'.admin_url( 'admin.php?page=' . $al2fb_menu_slug).'" method="POST"> 
	...
	add_action('admin_init', 'on_plugin_activated_readygraph_al2fb_redirect');
	add_option('readygraph_connect_notice','true');

function rg_al2fb_popup_options_enqueue_scripts() {
