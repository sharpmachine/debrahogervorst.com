	...
	<div id="content">
		<div id="options_tabs" class="ui-tabs">
			<ul class="options_tabs ui-tabs-nav" role="tablist" id="nav">					
				<li class="active">
					<a id="general">
						<div class="dashicons dashicons-admin-generic"></div><?php _e('Settings',WEBLIZAR_TWITTER_TEXT_DOMAIN);?>
					</a>
				</li>
				<li>
					<a id="needhelp">
						<div class="dashicons dashicons-editor-help"></div><?php _e('Need Help', WEBLIZAR_TWITTER_TEXT_DOMAIN);?>
					</a>
				</li>
				<li>
					<a id="ourproduct">
						<div class="dashicons dashicons-plus"></div><?php _e('Our Products', WEBLIZAR_TWITTER_TEXT_DOMAIN);?>
					</a>
				</li>
			</ul>					
