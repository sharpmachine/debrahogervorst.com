...
class WeblizarTwitter extends WP_Widget {
	function __construct() {
		...
		'Twitter Tweets', // Name
		array( 'description' => __( 'Display latest tweets from your Twitter account', WEBLIZAR_TWITTER_TEXT_DOMAIN )));
	}
    /*
...
function Twitter_by_weblizar_page_function() {
	...
	wp_enqueue_script('jquery_min_fine_access', WEBLIZAR_TWITTER_PLUGIN_URL.'js/jquery-1.8.2.min.js');
