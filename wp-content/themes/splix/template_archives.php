...
<?php	if (have_posts()) {
            ...
            <?php	} ?>
                    ...
                    <div class="entry">
						<li class="linkcat"><h2><?php _e('Archives by Month:','splix'); ?></h2><ul><?php wp_get_archives('show_post_count=1'); ?></ul></li>
                        <li class="linkcat"><h2><?php _e('Archives by Year:','splix'); ?></h2><ul><?php wp_get_archives('type=yearly&show_post_count=1'); ?></ul></li>
                    </div>
			<!-- <?php	if(function_exists('the_ratings')) { ?>
                        <span class="rating">
            <?php			the_ratings(); ?>
                        </span>
            <?php	} ?> delete the comment tags if you want to use ratings for the archives page -->                    
                    <div class="metadata">
				<?php	if($options['page_show_date']) { ?>
